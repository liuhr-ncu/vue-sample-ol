  ...
  export default {
    ...
    methods: {
      ...
      handleMapReady(featureManagerPool) {
        ...
        const cfm = FeatureManagerFactory.create(FeatureType.COMPOSE);
        ...
        let features = this._initFeatures(100, 100);
      ...
      _initFeatures(personNumber, vehicleNumber) {
        ...
        while (personNumber-- > 0) {
          features.push({
            ...
            lng: 115.7771390590016 + Math.random() * 0.00012 * personNumber,
            lat: 40.305671723555804 + Math.random() * 0.00009 * personNumber,
